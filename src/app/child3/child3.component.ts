...
export class Child3Component implements AfterViewInit {
  ...
  @ViewChild("setValue") setValue: ElementRef;
  ...
  ngAfterViewInit() {
    ...
    const nextSibling = this.sibling.nativeElement.nextSibling; //nextSibling
    console.log(nextSibling);
  }

  onClick() {
    this.renderer.removeChild(this.parent.nativeElement, this.p); //removeChild()
    this.renderer.setValue(this.setValue.nativeElement, "testing"); //setValue()
    console.log(this.setValue.nativeElement);
  }
